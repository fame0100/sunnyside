function eventListeners(){const e=document.querySelector(".mobile-menu");e.addEventListener("click",navegacionResponsive),e.addEventListener("click",bgMenu)}function navegacionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}function bgMenu(){document.querySelector(".derecha").classList.toggle("bg-menu")}
